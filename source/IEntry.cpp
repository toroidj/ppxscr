/*-----------------------------------------------------------------------------
	Paper Plane xUI  Script Module				IEntry(指定エントリ情報)
-----------------------------------------------------------------------------*/
#define STRICT
#include <windows.h>
#include <activscp.h>
...
{
	(*m_ppxa)->Function(*m_ppxa, PPXCMDID_CSRINDEX, &m_index); // カーソル位置を初期化
	return;
}
